...
/*
	...
	function requireAttendeesField () {
        return [
    ...
    function config_options_appField () {
		return [
	...
	function  config_attendees_appField () {
		return [
	...
	function  config_payment_appField () {
		return [
	...
	function  config_receipt_appField () {
		return [
	...
	function config_options_layoutField () {
		return [
	...
	function  config_attendees_layoutField () {
		return [
	...
	function  config_payment_layoutField () {
		return [
	...
	function  config_receipt_layoutField () {
		return [
		                    ...
		                    <tbody>
		                        {{#each events}}
		                            <tr data-id="{{dbURI}}">
		                                ...
		                                <td>{{title}}</td>
		                                <td>{{#MongoDate field="display_date"}}</td>
		                                <td>{{time}}</td>
		                                <td>{{cost}}</td>
	            ...
	            <div class="bottom-container">
		            ...
		            <div class="ui tab" data-tab="Registration">
		                {{#DocumentFormLeft}}
		                    ...
		                    {{#FieldLeft require_attendee_names "Require Attendee Names"}}
		                {{/DocumentFormLeft}}
		            ...
		            <div class="ui tab" data-tab="Advanced">
		                {{#DocumentFormLeft}}
		                    ...
		                    {{#FieldLeft config_options_app config_options_app}}
		                    {{#FieldLeft config_attendees_app config_attendees_app}}
		                    {{#FieldLeft config_payment_app config_payment_app}}
		                    {{#FieldLeft config_receipt_app config_receipt_app}}
		                    {{#FieldLeft config_options_layout config_options_layout}}
		                    {{#FieldLeft config_attendees_layout config_attendees_layout}}
		                    {{#FieldLeft config_payment_layout config_payment_layout}}
		                    {{#FieldLeft config_receipt_layout config_receipt_layout}}
		                {{/DocumentFormLeft}}
